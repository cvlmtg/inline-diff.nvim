...
| File | What it covers |
|---|---|
| `tests/diff_spec.lua` | Diff parsing, LCS algorithm, word-level diff |
| `tests/highlight_spec.lua` | HSL color math, round-trips, boost formula |
| `tests/render_spec.lua` | Extmark chunk and highlight builders |
